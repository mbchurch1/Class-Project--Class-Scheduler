 ...
 * All faculties have a unique id. This directory is comprised of 
 * a sortedList. The faculty records are sorted by lastName, 
 * firstName, and ID.
 * 
 * @author Will Goodwin
 * @author Matt Church
...
public class FacultyDirectory {
	...
	/**
	 * Creates an empty faculty directory.  All faculties in the previous
	...
	/**
	 * Removes the Faculty with the given ID from the list of Faculties.
	 * Returns true if the Faculty is removed and false if the Faculty is 
	 * not in the list.
	 ...
	 * @return two-dimensional String array containing Faculty first name, last name, and id.
	 */
	 ...
	 * 		the FacultyDirectory to the file passed in from 
	 * 		FacultyRecordIO
	 */

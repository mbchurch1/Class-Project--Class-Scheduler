...
public class CourseTest {
    ...
    public void testSetName() {
        ...
        c = null;
        try {
            c = new Course("HESFQ 101", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
            fail();
        } catch (IllegalArgumentException e) {
            assertNull(c);
            assertEquals("Invalid name", e.getMessage());
        ...
        c = null;
        try {
            c = new Course("HESF 01", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
            fail();
        } catch (IllegalArgumentException e) {
            assertNull(c);
            assertEquals("Invalid name", e.getMessage());
        ...
        c = null;
        try {
            c = new Course("CSC 2167", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
            fail();
        } catch (IllegalArgumentException e) {
            assertNull(c);
            assertEquals("Invalid name", e.getMessage());
        ...
        // Testing for CourseNameValidator.isValid() to return false because not enough digits - IAE should be thrown
        c = null;
        try {
            c = new Course("CSC21", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
            fail();
        } catch (IllegalArgumentException e) {
            assertNull(c);
            assertEquals("Invalid name", e.getMessage());
    ...
    public void testSetSection() {
        ...
        // Test that setting the section to "0A9" doesn't change the section (or
        // anything else).
        try {
            c.setSection("0A9");
            fail();
    ...
    public void testToString() {
        Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
        String s1 = "CSC216,Software Development Fundamentals,001,3,sesmith5,50,MW,1330,1445";
        assertEquals(s1, c1.toString());

        Activity c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, "A");
        String s2 = "CSC216,Software Development Fundamentals,001,3,sesmith5,50,A";
        assertEquals(s2, c2.toString());
    }
    /**
	 * Test compareTo, ensuring that it can accurately compare the fields of two Course objects
	 */
	@Test
	public void testCompareTo() {
		Course s1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Course s2 = new Course("CSC217", "SDF Lab", "601", 1, "mbchurch", ENROLLMENT_CAP, "A");
		...
		assertTrue(y > 0);
		// Test same name
		Course s3 = new Course("CSC217", "SDF Lab", "201", 1, "mbchurch", ENROLLMENT_CAP, "MW", 1245, 1330);
	...
	/**
	 * Test isDuplicate to make sure it works correctly
	 */
	@Test
	public void testIsDuplicate() {
		Course c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Course c2 = new Course("CSC217", "SDF Lab", "601", 1, "mbchurch", ENROLLMENT_CAP, "MW", 1245, 1330);
		Course c3 = new Course(NAME, "Software is cool", "102", 3, "mbchurch", ENROLLMENT_CAP, "TH", 930, 1045);
		// test two different Courses
		assertFalse(c1.isDuplicate(c2));
		// test Courses with same name
